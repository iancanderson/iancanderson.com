...
const Header = ({ headingLevel = 2 }: Props) => {
  const HeadingTag = `h${headingLevel}` as const;
  
  return (
    <div className="mt-6 mb-10">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between">
        <HeadingTag className="inline-block brutal-border bg-[color:var(--brutal-card)] px-3 py-2 text-3xl md:text-5xl font-extrabold tracking-tight text-[color:var(--brutal-fg)] self-center md:self-start text-center md:text-left">
