...
const Intro = ({ headingLevel = 1 }: Props) => {
  const HeadingTag = `h${headingLevel}` as const;
  
  return (
    <section className="flex-col md:flex-row flex items-center md:justify-between mt-8 mb-12 md:mb-10">
      <HeadingTag className="inline-block brutal-border bg-[color:var(--brutal-card)] px-3 py-2 text-3xl md:text-5xl font-extrabold tracking-tight text-[color:var(--brutal-fg)] md:pr-8">
